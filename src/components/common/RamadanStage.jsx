...
function GlowOrnament() {
  return (
    <div className="pointer-events-none absolute inset-0">
      <div className="absolute left-1/2 top-[-120px] h-[480px] w-[480px] -translate-x-1/2 rounded-full bg-[#c9a227]/10 blur-3xl" />
      <div className="absolute bottom-[-160px] right-[-160px] h-[520px] w-[520px] rounded-full bg-[#2d8cff]/10 blur-3xl" />
      <div className="absolute left-[-180px] top-[30%] h-[520px] w-[520px] rounded-full bg-[#f6d365]/10 blur-3xl" />
