      ...
      {role === ROLES.ADMIN ? (
        <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <Link to="/saas/tournaments/wizard" className="rounded-xl bg-[var(--primary-color)] px-3 py-2 text-xs font-semibold text-[#07162b]">
              Create Draft
            </Link>
            <Link to="/saas/schedule" className="rounded-xl border border-white/15 bg-white/5 px-3 py-2 text-xs">
              Manage Tournament
            </Link>
